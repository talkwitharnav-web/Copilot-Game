...
- **1** &middot; INTERFACE.md
  - **84** &middot; 0. The five things worth knowing before designing anything
- **94** &middot; 1. What the screen actually is
  - **96** &middot; 1.1 Two cards, side by side
  - **131** &middot; 1.2 The right-hand card
  - **139** &middot; 1.3 The crafting table screen
  - **150** &middot; 1.4 Creative
  - **154** &middot; 1.5 The screens we actually ship, and how they differ *(2026-08-10)*
- **183** &middot; 2. Tabs
- **207** &middot; 3. The craftable indication — the part to get right
  - **209** &middot; 3.1 Per-cell background: six states, always on
  - **237** &middot; 3.1b The red state is not confined to the catalogue
  - **252** &middot; 3.2 The filter toggle — a different feature
- **272** &middot; 4. Mechanics
  - **274** &middot; 4.1 Two questions, two pieces of code
  - **285** &middot; 4.2 The craftable check is bipartite matching, not a greedy count
  - **304** &middot; 4.3 Which recipes appear where
  - **310** &middot; 4.4 Unlocking — and why we can ignore it for now
  - **318** &middot; 4.5 Selecting a recipe
  - **338** &middot; 4.5b Clicking a catalogue entry — the catalogue is a source, not a container
  - **354** &middot; 4.6 Ordering and grouping
  - **360** &middot; 4.7 Search
- **368** &middot; 5. What the reference art measures
  - **372** &middot; 5.1 The whole visual language is six greys
  - **387** &middot; 5.2 Panel frame, identical on every panel
  - **399** &middot; 5.3 The slot tile — 18 × 18, packed on an 18 px pitch with no gap
  - **409** &middot; 5.4 Key rectangles
  - **439** &middot; 5.5 Recipe-book sprites
  - **443** &middot; 5.6 There are no tab icons
  - **447** &middot; 5.7 What the screenshot measures, at 3×
  - **462** &middot; 5.8 The extracted icon set
- **474** &middot; 6. What we have, and what is missing
  - **476** &middot; 6.1 Reusable unchanged
  - **491** &middot; 6.2 Genuinely missing, in order of how much they hurt
  - **501** &middot; 6.3 Two traps specific to us
- **511** &middot; 7. The build order
  - **537** &middot; Sources
...
> ⚠️ **This "where we stand" block is a snapshot of 2026-08-10 and has not been re-derived since.
> Nine days and several rounds have passed** — M23 rewrote the renderer, M29b–m added content, and
> two correctness rounds ran on 2026-08-18 and 2026-08-19. **Treat every slice status below as
> historical.** What was re-checked on 2026-08-19 and still holds: **the HUD sheet is
> 185 × 1687** (measured off `assets/textures/hud.png` directly). What is current for the interface
> as a whole is **`UI.md` §0.4**, whose eleven binding rules override anything here, and
> `SYSTEM_MEMORY.md`'s `## HUD` section for what the code actually draws today.
>
> **The measured geometry in the rest of this file does not rot** — it comes from the reference
> capture and the UI data, not from our build — which is why only this block carries the warning.
