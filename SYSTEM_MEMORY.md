...
**Index** - 146 sections. Line numbers, so a reader can jump straight there.
**Generated by `tools/index-docs.ps1`; do not hand-edit. Re-run it after editing this file.**

- **1** &middot; SYSTEM_MEMORY.md
  - **169** &middot; Critical Invariants
  - **182** &middot; Verified Environment
    - **203** &middot; Two GPUs
    - **207** &middot; What hardware this actually needs
    - **218** &middot; Third-party Vulkan layers are present on this machine
  - **224** &middot; Repository Layout
  - **292** &middot; Build System
    - **294** &middot; Targets
    - **303** &middot; Presets
  - **325** &middot; Dependencies
    - **340** &middot; Dependency sources are nested Git repositories, and that is expected
  - **346** &middot; Engine Architecture
  - **380** &middot; Game Architecture (current)
  - **422** &middot; World Generation
    - **428** &middot; The five stages
    - **438** &middot; The climate fields
    - **454** &middot; Shaping
    - **474** &middot; Density and the lattice
    - **505** &middot; Surface rules
    - **544** &middot; Caves
    - **560** &middot; Ores
    - **588** &middot; Biomes
    - **602** &middot; Named divergences
    - **614** &middot; Measuring it
  - **636** &middot; Frame Pacing
  - **648** &middot; Shaders
  - **654** &middot; Rendering Approach
    - **664** &middot; What a frame is made of
    - **685** &middot; Winding and culling — do not "fix" this by reasoning
    - **689** &middot; Camera and projection
  - **697** &middot; Controls
    - **733** &middot; Rumble
  - **836** &middot; Player Physics
    - **865** &middot; Water
  - **967** &middot; Block Textures
    - **984** &middot; Creature skins
    - **1014** &middot; Reviewing a model
    - **1060** &middot; The species table
    - **1092** &middot; How a population arrives, and what happens to it
    - **1113** &middot; How a creature decides what to do
    - **1138** &middot; A villager's day
    - **1160** &middot; The iron golem
    - **1173** &middot; Fighting at a distance, and what a creature holds
    - **1191** &middot; What it takes to be noticed, and what it takes to be forgotten
    - **1207** &middot; Closing in, and the blow itself
    - **1234** &middot; Dying
    - **1259** &middot; What a Bramble's blast actually does
    - **1273** &middot; How limbs move
    - **1291** &middot; Finding a way round
    - **1319** &middot; Getting up a hill
    - **1337** &middot; Spawn eggs
    - **1349** &middot; Creature sizes
    - **1395** &middot; The smoker
    - **1403** &middot; The smithing table
    - **1411** &middot; The chest, and the four families that are one
    - **1447** &middot; The stowbox
    - **1461** &middot; The hopper
    - **1471** &middot; The stonecutter
    - **1477** &middot; The bell, the cauldron and the lectern
    - **1491** &middot; The id space
    - **1505** &middot; Adding a block type
    - **1533** &middot; The four box sets, and which one is the drawn shape
    - **1548** &middot; Breaking cracks
    - **1565** &middot; What the ground-cover pass places
    - **1587** &middot; Authoring
    - **1603** &middot; Items and drops
    - **1641** &middot; Crafting
    - **1657** &middot; The crafting table
    - **1665** &middot; The furnace
    - **1691** &middot; Mining and tools
    - **1707** &middot; Torches
  - **1717** &middot; Staying Alive
  - **1748** &middot; Effects, potions and brewing
  - **1780** &middot; Sound
  - **1807** &middot; HUD
    - **1817** &middot; The sprite sheet
    - **1827** &middot; Text
    - **1839** &middot; Hotbar
    - **1849** &middot; The catalogue card
    - **1873** &middot; Transparency
    - **1877** &middot; Startup
  - **1905** &middot; Terrain Generation
    - **1909** &middot; Biomes
    - **1921** &middot; The column, top to bottom
    - **1927** &middot; Ores
    - **1935** &middot; Caves
    - **1943** &middot; Structures
    - **1957** &middot; Villages
    - **1983** &middot; Block shapes
  - **2022** &middot; Water
    - **2036** &middot; How a water surface is drawn
  - **2056** &middot; Lava, fire and TNT
    - **2093** &middot; Waterlogging
    - **2108** &middot; Cutout blocks
    - **2120** &middot; Flow
    - **2128** &middot; Drawing it
  - **2134** &middot; Falling blocks
  - **2148** &middot; Cut shapes: stairs, slabs, walls, fences, gates, carpets and panes
    - **2170** &middot; Signs and banners are the same trick
  - **2186** &middot; Redstone components
  - **2200** &middot; Collectibles
  - **2211** &middot; Projectiles
    - **2243** &middot; Two screen layers, plus a third for the cursor
  - **2251** &middot; Ladders, vines and the third table run
    - **2255** &middot; Glass, and where its transparency actually lives
    - **2281** &middot; Modelled blocks
    - **2306** &middot; Every block is checked against the reference's own model
    - **2323** &middot; A dropped block is a miniature of the block
  - **2342** &middot; World Persistence
  - **2376** &middot; Rendering Statistics
    - **2382** &middot; Diagnostics overlay
  - **2396** &middot; Sun, moon and sky
    - **2426** &middot; The sky is a gradient, written by the lighting pass
    - **2446** &middot; Rain on a surface, and shafts under water
    - **2452** &middot; Resolution scaling
  - **2462** &middot; Clouds
  - **2485** &middot; Weather
    - **2493** &middot; The falling curtain
    - **2511** &middot; Lightning
    - **2524** &middot; Snow settling and ice forming
  - **2536** &middot; Particles
  - **2556** &middot; Wind and foliage
  - **2580** &middot; Image quality
  - **2596** &middot; Cast shadows
  - **2625** &middot; Lighting
    - **2647** &middot; Smooth lighting and ambient occlusion
  - **2661** &middot; Meshing
    - **2675** &middot; What the mesher is given
    - **2681** &middot; The distance tier (`detail_distance`)
    - **2700** &middot; Keeping the boundary honest while moving
  - **2731** &middot; Culling
  - **2743** &middot; Settings
  - **2796** &middot; Threading
    - **2801** &middot; What runs where
    - **2812** &middot; Surviving the world's destruction
    - **2818** &middot; Stale results
  - **2831** &middot; Chunk Streaming
    - **2853** &middot; Not stalling the GPU
    - **2861** &middot; Watching for leaks
    - **2874** &middot; Getting geometry onto the GPU
  - **2890** &middot; GPU Memory Ownership
    - **2898** &middot; Buffers are sub-allocated
  - **2916** &middot; Runtime Behavior
  - **2929** &middot; Current Validation Baseline
  - **2949** &middot; Update Discipline
...
>
> **What the game is right now** is described once, in `START-HERE.md` §3 — this file is the detail underneath it, section by section. In one line: an endless streamed world under a real sun, moon and cascaded shadows, with twenty-seven biomes, **2223 block ids and 1029 catalogue entries against 1019 recipes**, timed and tiered digging across five tool tiers, crafting, smelting in three kinds of furnace, **eight container and workstation screens**, farming, weather, particles, 57 creature species with behaviour and animation, survival systems, and saves that survive a restart.
>
...
│   ├── make-reference-sounds.ps1     510 recordings across 162 events, staged beside the exe as sounds-reference/
...
> ⭐ **A claim lives on the creature and nowhere else.** "Is this bed taken" is a linear scan of a population measured in tens, not a map on `Creatures`. Same argument as the double chest's pairing: a second copy would have to be saved, kept in step, and repaired every time a block was broken. Breaking the claimed block simply makes the next scan drop the claim, and losing a job site loses the trade with it.
...
**`isChest` covers five blocks: the plain chest, the barrel, the trapped chest, the ender chest and all seventeen stowboxes.** One screen, one block entity, one spill on break, one shift-click rule. That single predicate is the whole cost of four of them, and it is the pattern to reach for whenever a new container arrives.
...
**`ItemEntities::spawn` and `Inventory::add` both gained a `damage` parameter** to carry it, and that fixed a pre-existing bug on the way: a damaged tool spilled out of a broken chest used to come back undamaged.
...
> **2223 of the 4096 are used.** That is over half, and the run rate is no longer slow — doors alone took 384 and beds 128. The ceiling is real rather than theoretical now, so **a family that would spend hundreds of ids on orientation deserves a moment's thought about a side array first.**
...
**The game's half.** A hundred and sixty-two events and thirty-four creature voice families, each with up to eight recordings picked at random and pitched slightly differently on every play, which is most of what stops a repeated noise reading as a loop.

Two groupings carry almost all of it:

- **Blocks resolve to one of ten materials by family test, not by list** — stone, wood, grass, gravel, sand, cloth, snow, glass, coral, wet, or silent. Two thousand block ids are covered by about a dozen questions, a new block inherits the right footstep the day it is added, and a cut shape asks `shapedParent`, so six hundred stairs and slabs cost one line. Unknown blocks fall through to stone unless they burn, in which case wood.
...
**Current reading: 3186 blocks drawn, 1792 matched a reference model and agree, 0 disagree, 1370 have no model to check against.** The 1370 are ours or have no single-model equivalent — cut shapes, water levels, crops, the appended runs.
...
**A block is drawn in three places and they have to be told the same things.** The mesher, `appendBlockIcon`, and `ItemEntities::buildMesh` are three separate implementations of "draw this block as boxes"; they share only the box list. Two more faults of exactly that shape were found by play on 2026-08-11, one in each of the non-mesher paths, and both were invisible from the world:
...
> ⛔ **Chunks and the player file carry separate version constants, and that separation is load-bearing.** `kChunkFormatVersion` (currently 3) versions chunk files; `kFormatVersion` (currently **3**) versions `player.dat`. **Bumping the chunk version is how a worldgen fix reaches a world that has already been played** — every stale chunk fails its header check and is regenerated. Doing that must not cost the player their inventory or position, which is exactly why the two numbers are not one. Waterlogging bumped the chunk version to 2; the 16-bit block id bumped it to 3. M21's survival fields bumped the *player* version to 2, and the inventory bumped it to 3 — neither changed anything about the world.
>
...
- **Compile:** clean rebuild from scratch in both debug and release, **zero warnings** at `/W4 /permissive-`. Shaders compile to SPIR-V as part of the build.
...
- **Content:** 2871 block ids, 1343 catalogue entries, 1152 recipes with none broken and none shadowing another, 57 species, and every texture layer claimed by exactly one material family. 1347 block and item textures staged into `blocks-reference/`.
- **Audio:** the device opens at 48 kHz stereo, all 510 staged recordings decode, and all 162 events plus all 102 creature voice banks find recordings. Distance rolloff verified by a sound played out of range starting no voice.
