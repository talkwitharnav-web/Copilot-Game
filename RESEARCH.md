...
- **1** &middot; RESEARCH.md
  - **133** &middot; Table of contents
- **156** &middot; 1. Entity physics
  - **158** &middot; 1.1 The tick model
  - **188** &middot; 1.2 Converting tick-space to delta time — the formulas we actually need
  - **215** &middot; 1.3 The per-entity constant table
  - **238** &middot; 1.4 Player movement — derivation of 4.317 m/s
  - **270** &middot; 1.5 Jumping
  - **293** &middot; 1.6 Step height and collision
  - **313** &middot; 1.7 Entity-versus-entity collision — the architectural fact
  - **321** &middot; 1.8 Item entity physics
  - **341** &middot; 1.9 Hitbox table (Bedrock first)
  - **368** &middot; 1.10 Fall damage
  - **392** &middot; 1.11 Water and lava
- **421** &middot; 2. Combat
  - **423** &middot; 2.1 Attack cooldown — Java only
  - **429** &middot; 2.2 Attack damage — Bedrock
  - **446** &middot; 2.3 Knockback
  - **464** &middot; 2.4 Invulnerability — the rule that makes melee work
  - **476** &middot; 2.5 Targeting and aggro
  - **508** &middot; 2.6 Reach
  - **523** &middot; 2.7 Difficulty scaling
- **577** &middot; 3. Health, hunger and food
  - **579** &middot; 3.1 Health and damage
  - **598** &middot; 3.2 Hunger — three values, one visible
  - **620** &middot; 3.3 Food
  - **639** &middot; 3.4 Armour
- **667** &middot; 4. Mob spawning and despawning
  - **669** &middot; 4.1 Bedrock spawning
  - **684** &middot; 4.2 Spawning at chunk generation — `[JE]` only, and the biggest gap for us
  - **694** &middot; 4.3 Despawning — Bedrock
- **713** &middot; 5. Mob drops, breeding and babies
  - **715** &middot; 5.1 Drop rules
  - **724** &middot; 5.2 The table for our roster
  - **741** &middot; 5.3 Breeding and growth
- **769** &middot; 6. Mob behaviour — the species we have
  - **773** &middot; 6.1 Master table
  - **795** &middot; 6.2 Per-species behaviour worth implementing
  - **825** &middot; 6.3 Creeper — our Bramble's source
- **874** &middot; 7. Mob behaviour — what we could add
  - **876** &middot; 7.1 Archetype A — land quadrupeds *(reuses everything we have)*
  - **901** &middot; 7.2 Archetype B — flying
  - **915** &middot; 7.3 Archetype C — swimming ✅ **built, M20i (2026-08-05)**
  - **954** &middot; 7.4 Archetype D — bipedal
  - **962** &middot; 7.5 Naming
- **968** &middot; 8. The Bedrock AI architecture
  - **972** &middot; 8.1 The shape
  - **989** &middot; 8.2 A real vanilla ordering — the chicken
  - **1007** &middot; 8.3 Key component parameters worth knowing
  - **1024** &middot; 8.4 Navigation versus movement — the idea most worth stealing
  - **1045** &middot; 8.5 Pathfinding node costs
  - **1076** &middot; 8.6 Spawn rules — the cleanest thing in the whole design
  - **1096** &middot; 8.7 What to take, and what to skip
  - **1112** &middot; 8.8 The migration path — every step compiles and runs
- **1148** &middot; 9. Blocks, fluids and plants
  - **1150** &middot; 9.1 Fluid mechanics - BUILT; this is now a pointer
  - **1189** &middot; 9.2 Gravity blocks
  - **1201** &middot; 9.3 Crop growth — the exact formula
  - **1219** &middot; 9.4 Random ticks — the clock everything runs on
  - **1232** &middot; 9.5 Leaf decay
  - **1238** &middot; 9.6 Grass spread
  - **1249** &middot; 9.7 Solid vs opaque vs full block — six independent properties
  - **1272** &middot; 9.8 Stairs and slabs
  - **1282** &middot; 9.9 Fire
- **1305** &middot; 10. Mining, tools, smelting, XP
  - **1307** &middot; 10.1 The mining formula
  - **1342** &middot; 10.2 Smelting
  - **1357** &middot; 10.3 Ore drops
  - **1369** &middot; 10.4 Experience
- **1379** &middot; 11. Crafting and recipes
  - **1381** &middot; 11.1 Matching rules
  - **1385** &middot; 11.2 Core recipes
- **1424** &middot; 12. Light
- **1456** &middot; 13. Time, weather and sky
  - **1458** &middot; 13.1 The day
  - **1471** &middot; 13.2 The sky angle formula
  - **1481** &middot; 13.3 Weather — two flags, two timers
  - **1501** &middot; 13.4 Burning in sunlight
- **1520** &middot; 14. Ticking, chunks and persistence
  - **1522** &middot; 14.1 Per-tick order (Java, and the ordering is the point)
  - **1547** &middot; 14.2 Scheduled versus random ticks
  - **1560** &middot; 14.3 Block updates — depth-first, not queued
  - **1573** &middot; 14.4 Chunk load levels
  - **1590** &middot; 14.5 Region files
- **1613** &middot; 15. World generation
  - **1619** &middot; 15.1 The shape of the system
  - **1649** &middot; 15.2 Climate parameters and how a biome is chosen
  - **1799** &middot; 15.3 Seed, noise and sampling resolution
  - **1857** &middot; 15.4 Terrain shaping: splines, density, and the Y geometry
  - **1979** &middot; 15.5 Surface rules — which block goes on top
  - **2103** &middot; 15.6 Caves and aquifers
  - **2224** &middot; 15.7 Ores, features and the placement RNG
  - **2374** &middot; 15.8 What else a biome carries
  - **2437** &middot; 15.9 ▶ Where we stand
  - **2507** &middot; 15.10 The rules that keep a generated world sane
- **2649** &middot; 17 · Projectiles, the bow and the arrow
  - **2653** &middot; 17.1 The numbers, and their units
  - **2679** &middot; 17.2 The five things that are not obvious
  - **2691** &middot; 17.3 Collision
  - **2699** &middot; 17.4 The model
  - **2711** &middot; 17.5 What we deliberately do not have
  - **2715** &middot; 17.6 How a mob decides to shoot — `minecraft:behavior.ranged_attack`
  - **2741** &middot; 17.7 The witch, which is far more specified than the skeleton
  - **2771** &middot; 17.8 The drowned's trident, gated three ways
- **2786** &middot; 18. Thrown items: the pearl and the egg
  - **2790** &middot; 18.1 The table, and what is shared
  - **2807** &middot; 18.2 What is genuinely undocumented
  - **2812** &middot; 18.3 The rest
  - **2820** &middot; 19. Villages, villagers and the iron golem
  - **2960** &middot; Sources
