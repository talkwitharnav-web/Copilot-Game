...
- **1** &middot; RESEARCH.md
  - **130** &middot; Table of contents
- **153** &middot; 1. Entity physics
  - **155** &middot; 1.1 The tick model
  - **185** &middot; 1.2 Converting tick-space to delta time — the formulas we actually need
  - **212** &middot; 1.3 The per-entity constant table
  - **235** &middot; 1.4 Player movement — derivation of 4.317 m/s
  - **267** &middot; 1.5 Jumping
  - **290** &middot; 1.6 Step height and collision
  - **310** &middot; 1.7 Entity-versus-entity collision — the architectural fact
  - **318** &middot; 1.8 Item entity physics
  - **338** &middot; 1.9 Hitbox table (Bedrock first)
  - **365** &middot; 1.10 Fall damage
  - **389** &middot; 1.11 Water and lava
- **418** &middot; 2. Combat
  - **420** &middot; 2.1 Attack cooldown — Java only
  - **426** &middot; 2.2 Attack damage — Bedrock
  - **443** &middot; 2.3 Knockback
  - **461** &middot; 2.4 Invulnerability — the rule that makes melee work
  - **473** &middot; 2.5 Targeting and aggro
  - **505** &middot; 2.6 Reach
  - **520** &middot; 2.7 Difficulty scaling
- **574** &middot; 3. Health, hunger and food
  - **576** &middot; 3.1 Health and damage
  - **595** &middot; 3.2 Hunger — three values, one visible
  - **617** &middot; 3.3 Food
  - **636** &middot; 3.4 Armour
- **664** &middot; 4. Mob spawning and despawning
  - **666** &middot; 4.1 Bedrock spawning
  - **681** &middot; 4.2 Spawning at chunk generation — `[JE]` only, and the biggest gap for us
  - **691** &middot; 4.3 Despawning — Bedrock
- **710** &middot; 5. Mob drops, breeding and babies
  - **712** &middot; 5.1 Drop rules
  - **721** &middot; 5.2 The table for our roster
  - **738** &middot; 5.3 Breeding and growth
- **766** &middot; 6. Mob behaviour — the species we have
  - **770** &middot; 6.1 Master table
  - **792** &middot; 6.2 Per-species behaviour worth implementing
  - **822** &middot; 6.3 Creeper — our Bramble's source
- **871** &middot; 7. Mob behaviour — what we could add
  - **873** &middot; 7.1 Archetype A — land quadrupeds *(reuses everything we have)*
  - **898** &middot; 7.2 Archetype B — flying
  - **912** &middot; 7.3 Archetype C — swimming ✅ **built, M20i (2026-08-05)**
  - **951** &middot; 7.4 Archetype D — bipedal
  - **959** &middot; 7.5 Naming
- **965** &middot; 8. The Bedrock AI architecture
  - **969** &middot; 8.1 The shape
  - **986** &middot; 8.2 A real vanilla ordering — the chicken
  - **1004** &middot; 8.3 Key component parameters worth knowing
  - **1021** &middot; 8.4 Navigation versus movement — the idea most worth stealing
  - **1042** &middot; 8.5 Pathfinding node costs
  - **1073** &middot; 8.6 Spawn rules — the cleanest thing in the whole design
  - **1093** &middot; 8.7 What to take, and what to skip
  - **1109** &middot; 8.8 The migration path — every step compiles and runs
- **1145** &middot; 9. Blocks, fluids and plants
  - **1147** &middot; 9.1 Fluid mechanics - BUILT; this is now a pointer
  - **1186** &middot; 9.2 Gravity blocks
  - **1198** &middot; 9.3 Crop growth — the exact formula
  - **1216** &middot; 9.4 Random ticks — the clock everything runs on
  - **1229** &middot; 9.5 Leaf decay
  - **1235** &middot; 9.6 Grass spread
  - **1246** &middot; 9.7 Solid vs opaque vs full block — six independent properties
  - **1269** &middot; 9.8 Stairs and slabs
  - **1279** &middot; 9.9 Fire
- **1302** &middot; 10. Mining, tools, smelting, XP
  - **1304** &middot; 10.1 The mining formula
  - **1339** &middot; 10.2 Smelting
  - **1354** &middot; 10.3 Ore drops
  - **1366** &middot; 10.4 Experience
- **1376** &middot; 11. Crafting and recipes
  - **1378** &middot; 11.1 Matching rules
  - **1382** &middot; 11.2 Core recipes
- **1421** &middot; 12. Light
- **1453** &middot; 13. Time, weather and sky
  - **1455** &middot; 13.1 The day
  - **1468** &middot; 13.2 The sky angle formula
  - **1478** &middot; 13.3 Weather — two flags, two timers
  - **1498** &middot; 13.4 Burning in sunlight
- **1517** &middot; 14. Ticking, chunks and persistence
  - **1519** &middot; 14.1 Per-tick order (Java, and the ordering is the point)
  - **1544** &middot; 14.2 Scheduled versus random ticks
  - **1557** &middot; 14.3 Block updates — depth-first, not queued
  - **1570** &middot; 14.4 Chunk load levels
  - **1587** &middot; 14.5 Region files
- **1610** &middot; 15. World generation
  - **1616** &middot; 15.1 The shape of the system
  - **1646** &middot; 15.2 Climate parameters and how a biome is chosen
  - **1796** &middot; 15.3 Seed, noise and sampling resolution
  - **1854** &middot; 15.4 Terrain shaping: splines, density, and the Y geometry
  - **1976** &middot; 15.5 Surface rules — which block goes on top
  - **2100** &middot; 15.6 Caves and aquifers
  - **2221** &middot; 15.7 Ores, features and the placement RNG
  - **2371** &middot; 15.8 What else a biome carries
  - **2434** &middot; 15.9 ▶ Where we stand
  - **2504** &middot; 15.10 The rules that keep a generated world sane
- **2646** &middot; 17 · Projectiles, the bow and the arrow
  - **2650** &middot; 17.1 The numbers, and their units
  - **2676** &middot; 17.2 The five things that are not obvious
  - **2688** &middot; 17.3 Collision
  - **2696** &middot; 17.4 The model
  - **2708** &middot; 17.5 What we deliberately do not have
- **2714** &middot; 18. Thrown items: the pearl and the egg
  - **2718** &middot; 18.1 The table, and what is shared
  - **2735** &middot; 18.2 What is genuinely undocumented
  - **2740** &middot; 18.3 The rest
  - **2748** &middot; 19. Villages, villagers and the iron golem
  - **2888** &middot; Sources
